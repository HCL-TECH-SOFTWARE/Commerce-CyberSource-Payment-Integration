...
//Cybersource start
/**
 * Declare the AJAX service that generate cybersource keyid
 * return the keyid and hostname 
 */
wcService.declare({
	id: "ajaxCyberSourceGenerateKey",
	actionId: "ajaxCyberSourceGenerateKey",
	url: "AjaxCyberSourceGenerateKey",
	formId: ""
	...
	,successHandler: function(serviceResponse) {
		...
		cursor_clear();
		CheckoutPayments.cyberSourceFlexToken(serviceResponse.keyId,serviceResponse.URL);
